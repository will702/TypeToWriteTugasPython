...
class FirebaseLoginScreen(Screen, EventDispatcher):
        ...
        try:
            ...
            if platform == 'android':
                ...
                if all([res for res in granted]) != True:
                    self.dialog = MDDialog(title='RESTART', text='YOU NEED TO RESTART TO RELEASED ALL FEATURE',
                                           size_hint=(0.7, 1),
                                           buttons=[MDFlatButton(text='CLOSE', on_release=self.close_dialog)
                                               , MDRaisedButton(text='RESTART', on_release=self.func)])
    ...
    def show_password(self):
        ...
        if self.count % 2  == 0:
            ...
            snackbar = Snackbar(text="Your Password Is Invisible",duration=0.3)
            snackbar.show()
            ...
            from kivymd.uix.snackbar import Snackbar
            snackbar = Snackbar(text="Your Password is Visible", duration=0.3)
            snackbar.show()
    ...
    def display_loading_screen(self, *args):
        self.popup.ids.threedots.active = True
        self.popup.open()


    def hide_loading_screen(self, *args):
        self.popup.ids.threedots.active = False
        self.popup.dismiss()
